 ...
 *
 * âš ï¸ NEDEN VAR: Hostinger paneli bir dagitim icin "Tamamlandi / Akim" yazip
 * commit numarasini gostermesine ragmen, uygulama ESKI KODLA calismaya devam
 * edebiliyor â€” panelin etiketi webhook'tan geliyor, diskteki koddan degil.
 ...
 * calisan kod eskidir â€” panel ne yazarsa yazsin.
 */
const SURUM = "2026-08-30-16-teklif-silme";
