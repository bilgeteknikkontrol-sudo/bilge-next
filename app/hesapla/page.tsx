      ...
      <section className="py-16 md:py-20">
        <div className="mx-auto max-w-[1200px] px-5">
          <div className="mx-auto mb-10 max-w-[760px] text-center">
            <KirintiYolu ad="Süre Hesaplayıcı" yol="/hesapla" merkez />
            <span className="mt-3 inline-flex rounded-full bg-blue-soft px-4 py-1.5 text-sm font-bold text-blue">6331 · İş Ekipmanları Yönetmeliği Ek-III</span>
